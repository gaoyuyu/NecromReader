...
public class GankTagListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements ItemTouchHelperAdapter
{
...
//        {
//            DBUtils.updateGankTagById(context,data.get(i).getId(),i);
//        }

        DBUtils.getGankTagList(context);
    ...
    public GankTagListAdapter(Context context, List<GankTag> data)
    {
